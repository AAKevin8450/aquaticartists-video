...
Last Updated: 2025-12-19 19:18:00
...
- Video uploads create local proxies in `proxy_video` named `originalname_<proxy_spec>.ext`; `proxy_spec` is stored in proxy file metadata.
